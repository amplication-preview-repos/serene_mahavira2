...
@InputType()
class UserSurveyResponseCreateNestedManyWithoutCompanySurveysInput {
...
export { UserSurveyResponseCreateNestedManyWithoutCompanySurveysInput as UserSurveyResponseCreateNestedManyWithoutCompanySurveysInput };
