...
@InputType()
class UserTimeTrackingRequestUpdateInput {
  @ApiProperty({
    required: false,
  })
  @IsDate()
  ...
  @ApiProperty({
    required: false,
    type: () =>
      UserTimeTrackingRequestDetailUpdateManyWithoutUserTimeTrackingRequestsInput,
  })
  @ValidateNested()
  @Type(
    () =>
...
export { UserTimeTrackingRequestUpdateInput as UserTimeTrackingRequestUpdateInput };
