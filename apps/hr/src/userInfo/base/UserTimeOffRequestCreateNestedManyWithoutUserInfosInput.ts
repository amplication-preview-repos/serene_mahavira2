...
@InputType()
class UserTimeOffRequestCreateNestedManyWithoutUserInfosInput {
...
export { UserTimeOffRequestCreateNestedManyWithoutUserInfosInput as UserTimeOffRequestCreateNestedManyWithoutUserInfosInput };
