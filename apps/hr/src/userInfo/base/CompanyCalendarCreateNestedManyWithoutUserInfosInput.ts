...
@InputType()
class CompanyCalendarCreateNestedManyWithoutUserInfosInput {
...
export { CompanyCalendarCreateNestedManyWithoutUserInfosInput as CompanyCalendarCreateNestedManyWithoutUserInfosInput };
