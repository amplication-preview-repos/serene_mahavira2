...
export class UserRoleGrpcControllerBase {
  ...
  @GrpcMethod("UserRoleService", "userRoles")
  ...
  @GrpcMethod("UserRoleService", "userRole")
  async userRole(
  ...
  @swagger.ApiOkResponse({ type: UserRole })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("UserRoleService", "updateUserRole")
  ...
  @swagger.ApiOkResponse({ type: UserRole })
  @swagger.ApiNotFoundResponse({ type: errors.NotFoundException })
  @GrpcMethod("UserRoleService", "deleteUserRole")
